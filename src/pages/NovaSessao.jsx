...
export default function NovaSessao() {
  ...
  const [dataSessao, setDataSessao] = useState(nowLocalDatetime());
  ...
  useEffect(() => {
    api.get(`/clientes/${clienteId}`).then((res) => setCliente(res.data));
  }, [clienteId]);
  ...
  return (
    <div className="page">
      <div className="container" style={{ paddingBottom: 120 }}>
        ...
        <h2>Nova Sessão — {cliente.nome}</h2>
